...
app.post('/route/to/take', function(req, res) {
...
app.get('/team_stats', function(req, res)
{
  ...
  var query2 = 'SELECT count(*) FROM football_games WHERE visitor_score < home_score;';
...
app.get('/player_info', function(req, res)
{
  ...
  //var query2 = 'SELECT id,name, img_src FROM football_players WHERE id = ' + playerID + ';';
  db.task('get-everything', task => {
      return task.batch([
          task.any(query1)
      ]);
...
app.get('/player_info/select_player', function(req, res)
{
  ...
  // var query3 = 'SELECT count(*) FROM football_players inner join football_games on football_players WHERE id = ' + playerID + ';';
  var query3 = 'select count(*) from football_players inner join football_games on football_players.id = ANY(football_games.players) where football_players.id = ' + playerID + ';';
  db.task('get-everything', task => {
      return task.batch([
          task.any(query1),
          task.any(query2),
...
app.get('/player_info/select_player', function(req, res)
{
  ...
  //console.log(req.query);
  var query1 = 'SELECT * FROM football_games;';
  // var query2 = 'SELECT count(*) FROM football_players inner join football_games on football_players WHERE id = ' + playerID + ';';
  db.task('get-everything', task => {
      return task.batch([
          task.any(query1)
          // task.any(query2)
